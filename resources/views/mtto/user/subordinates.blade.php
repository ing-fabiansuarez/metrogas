                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <form action="{{ route('user.storesubordinates') }}" method="post">
                                                <td class="text-center">
                                                    <div class="form-check">
                                                        <input name="permiso" value="role" type="checkbox"
                                                ...
                                                <td class="text-center">
                                                    <button style="border: white; font-size: 1.5rem" type="submit"
                                                        class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Guardar">
                                                        <i class="fas fa-save text-secondary" aria-hidden="true"></i>
                                                    </button>
                                                </td>
                                            </form>
