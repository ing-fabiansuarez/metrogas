                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-0">Formulario Persona Juridica</h5>
                            </div>

                        </div>

                        <form action="{{ route('proveedores.admin.persona-juridica') }}" method="get">
                                    ...
                                    @foreach ($respuestasForm as $item)
                                        <tr>
                                            <td class="text-center">
                                                <a href="{{ route('proveedores.admin.persona-juridica.ver', $item->id) }}">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $item->id }}</p>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <a href="{{ route('proveedores.admin.persona-juridica.ver', $item->id) }}">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $item->razon_social }}</p>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <a href="{{ route('proveedores.admin.persona-juridica.ver', $item->id) }}">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $item->nit }}</p>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->digito_verificador }}
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $item->correo_electronico_notificacion }}
                                                </p>
                                            </td>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('proveedores.admin.persona-juridica.exportar') }}" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            @csrf
                            <button type="submit" name="r" value="bruto" style="color: white" class="btn bg-secundary">Exportar Datos En Bruto</button>
