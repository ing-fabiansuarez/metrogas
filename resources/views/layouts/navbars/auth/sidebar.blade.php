    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('menu-mantenimientos') ||
                Request::is('cargos') ||
                Request::is('usuarios') ||
                ...
                Request::is('otros-gastos')
                    ...
                    <div
                        ...
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('menu-mantenimientos') || Request::is('usuarios') || Request::is('usuarios/create') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('') ? 'active' : '' }}" href="{{ route('viatic.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('') ? 'active' : '' }}" href="{{ route('viatic.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Direccion Financiera</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('') ? 'active' : '' }}" href="{{ route('viatic.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('') ? 'active' : '' }}" href="{{ route('viatic.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Tesoreria</span>
                </a>
            </li>
        </ul>
    </div>
