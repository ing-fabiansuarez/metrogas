        ...
        <ul class="navbar-nav">
            ...
            @can('menu-mainten')
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('mantenimientos*') ? 'active' : '' }}"
                        href="{{ route('menu-mainten') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('mantenimientos') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
            ...
            <li class="nav-item">
                ...
                Request::is('solicitud-viaticos/*')
                    ...
                    <span class="nav-link-text ms-1">{{ __('sidebar.viatic_request') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('legalizaciones*') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Legalización</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('por-aprobar') ? 'active' : '' }}" href="{{ route('byAprove') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            @can('report')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('reportes/solicitud-anticipos') ? 'active' : '' }}"
                        href="{{ route('report.viaticrequest') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-regular fa-code ps-2 pe-2 text-center text-dark {{ Request::is('mantenimientos') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">Solicitud de Anticipos</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('reportes/legalizaciones') ? 'active' : '' }}"
                        href="{{ route('report.legalization') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">legalizaciones</span>
                    </a>
                </li>
            @endcan
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('subalternos') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-regular fa-user ps-2 pe-2 text-center text-dark {{ Request::is('mantenimientos') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            @can('gestionarFormularioDatosPreoperacionales')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('form-datos-preoperacionales/datos-preoperacioneles-moto*') ? 'active' : '' }}"
                        ...
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-solid fa-bars ps-2 pe-2 text-center text-dark {{ Request::is('form-datos-preoperacionales/moto*') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('form-datos-preoperacionales/carro*') ? 'active' : '' }}"
                        href="{{ route('admin.preoperacional.carros') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-regular fa-user ps-2 pe-2 text-center text-dark {{ Request::is('form-datos-preoperacionales/carro*') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
