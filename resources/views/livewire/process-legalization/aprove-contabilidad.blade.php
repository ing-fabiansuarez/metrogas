    ...
    <div>
        ...
        <div class="row mt-3 justify-content-center">
            <div class="col-md-8">
                ...
                @if ($legalization->canContabilidad())
                    <div class="form-group">
        ...
        <script>
            Livewire.on('beforeAprove', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('process-legalization.aprove-contabilidad', 'aproveLegalization');
                    }
                })
            });
            Livewire.on('beforeCanceled', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('process-legalization.aprove-contabilidad', 'canceledLegalization');
                    }
                })
            });
            Livewire.on('beforeRechazar', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('process-legalization.aprove-contabilidad', 'rechazarLegalization');
                    }
                })
            });
