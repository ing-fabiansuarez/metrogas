<div>
    <div class="card mb-1">
        <div class="card-header pb-0 px-3 pt-3">
            <div class="d-flex flex-row justify-content-between">
                ...
                @include('livewire.destination-site.create')
            </div>
            <div class="row">
                    ...
                    <thead>
                        <tr>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                {{ __('forms.destination_site.id') }}
                            </th>

                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                {{ __('forms.destination_site.name') }}
                            </th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                {{ __('forms.updated_at') }}
                            </th>
    ...
    <!-- Modal Editar -->
    @include('livewire.destination-site.update')
            ...
            Livewire.on('deletePost', objId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('destination-site', 'destroy', objId);
                        Swal.fire(
                            '{{ __('forms.deleted') }}',
