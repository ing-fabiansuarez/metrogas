...
<div>
    <button class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal"
        data-bs-target="#modal-new-obj">{{ __('forms.other_expense.button.new') }}</button>
            ...
            <div class="modal-content">
                <form wire:submit.prevent="store">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('forms.other_expense.title.new') }}</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">{{ __('forms.other_expense.name') }}</label>
