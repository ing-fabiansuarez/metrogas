...
<div>
    <button class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#modal-new-obj">
        Nuevo tipo de identificación</button>
            ...
            <div class="modal-content">
                <form wire:submit.prevent="store">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Abreviatura</label>
                            <input wire:model.defer="abrev" type="text" class="form-control" id="recipient-name">
                            @error('abrev')
                                <span class="text-danger text-message-validation">
                                    {{ $message }}
                                </span>
