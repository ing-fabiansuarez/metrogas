...
use App\Models\OriginSite as ModelsOriginSite;
use Livewire\Component;
use Livewire\WithPagination;

class OriginSite extends Component
{
    ...
    public function __construct()
    {
        ...
        $this->title = __('forms.origin_site');
    }

    public function render()
    {
        $keyWord = '%' . $this->keyWord . '%';
        return view('livewire.origin-site.view', [
            'objetsModel' => ModelsOriginSite::latest()
    ...
    public function edit(ModelsOriginSite $object)
    {
        $this->model = $object;
    }
    ...
    public function destroy(ModelsOriginSite $object)
    {
        $object->delete();
    }
}
