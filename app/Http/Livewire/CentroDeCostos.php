...
use App\Models\CentroDeCostos as ModelsCentroDeCostos;
use Livewire\Component;
use Livewire\WithPagination;

class CentroDeCostos extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.centro-de-costos.view', [
            'objetsModel' => ModelsCentroDeCostos::latest()
    ...
    public function edit(ModelsCentroDeCostos $object)
    {
        $this->model = $object;
    }
    ...
    public function destroy(ModelsCentroDeCostos $object)
    {
        $object->delete();
    }
}
