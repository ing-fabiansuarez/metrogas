...
use App\Models\OtherExpense as ModelsOtherExpense;
...
class OtherExpense extends Component
{
    ...
    public function __construct()
    {
        ...
        $this->title = __('forms.other_expense');
    }

    public function render()
    {
        $keyWord = '%' . $this->keyWord . '%';
        return view('livewire.other-expense.view', [
            'objetsModel' => ModelsOtherExpense::latest()
    ...
    public function edit(ModelsOtherExpense $object)
    {
        $this->model = $object;
    }
    ...
    public function destroy(ModelsOtherExpense $object)
    {
        $object->delete();
    }
}
